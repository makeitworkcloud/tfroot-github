...
locals {
  github_repositories = toset([
    ".github", "ansible-project-libvirt", "ansible-site-cluster", "ansible-role-crc", "cflan", "charts", "agent-knowledge", "kustomize-cluster", "images", "shared-workflows", "terraform-libvirt-domain", "tfroot-aws", "tfroot-cloudflare", "tfroot-gcp", "tfroot-github", "tfroot-libvirt", "tfroot-namecheap", "www"
  ])
  archived_github_repositories = toset([
    "ansible-project-libvirt", "ansible-site-cluster", "ansible-role-crc"
  ])
